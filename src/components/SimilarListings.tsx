        ...
        >
          {prop.listings &&
            ...
            prop.listings.map((item: any) => (
              <motion.div
                className="item min-h-[23rem] rounded-lg min-w-[30rem] p-6"
                key={item.id}
              >
                <img
                  src={item.image}
                  alt="carousel"
                  className="w-full  rounded-t-lg pointer-events-none"
                />
                <div className="w-full rounded-b-lg bg-[#161616]">
                  <h1 className="text-white p-4 text-lg font-semibold">
                    {item.name}
                  </h1>
                  <div className="flex flex-row justify-center items-center rounded-lg w-full">
                    <span
